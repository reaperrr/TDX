...
{
	public class SpreadDamageXWarhead : DamageWarhead, IRulesetLoaded<WeaponInfo>
	{
		...
		public readonly WDist TargetExtraSearchRadius = new WDist(2560);

		[Desc("Damage percentage at each range step")]
		public readonly int[] Falloff = { 100, 50, 25, 12, 0 };
